...
def main():
    ...
    LOOP_WAIT_290          = float(p("loop_wait_290", 240.0))

    LOOP_BASELINE_20       = float(p("loop_baseline_20", 20.0))
    LOOP_DETECT_300        = float(p("loop_detect_300", 250.0))
